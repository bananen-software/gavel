...
class DepthOfInheritanceTreeMetricsServiceTest {
    ...
    public void measureDepthOfInheritanceTree() {
        final JavaClasses javaClasses = new ClassFileImporter()
                .importPackages("software.bananen.gavel.staticanalysis.examples.depthofinheritancetree");
        ...
        assertThat(measurements).containsOnly(
                new DepthOfInheritanceTree("software.bananen.gavel.staticanalysis.examples.depthofinheritancetree", "F", 7),
                new DepthOfInheritanceTree("software.bananen.gavel.staticanalysis.examples.depthofinheritancetree", "G", 8));
    }
}