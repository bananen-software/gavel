...
export class AppComponent implements OnInit {
  ...
  createWorkspace(): void {
    this.httpClient.post("http://localhost:8080/workspaces", {
      name: "pendenzenliste",
      path: "/home/dennis/workspace/github/flens-dev/pendenzenliste",
      excludedPaths: ["/test/", "/integrationTest/", "/generated/"],
      basePackage: "pendenzenliste"
    })
      .subscribe(res => console.log(res))
  }

  locateProjectsInWorkspace(): void {
    this.httpClient.post("http://localhost:8080/workspaces/1", {})
      .subscribe(res => console.log(res))
  }

  runAnalysis(): void {
    this.httpClient.post("http://localhost:8080/projects/1", {})
      .subscribe(res => console.log(res))
  }
